...
export default function QuestionContent({
  ...
  // Part 1, 2, 3, 4 không hiển thị script
  const hideScript = ["1", "2", "3", "4"].includes(part);
    ...
    <div className="flex-1 overflow-auto p-6 bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="max-w-6xl mx-auto space-y-8">
        {groupedQuestions.map((group, groupIdx) => {
          ...
          const hasMedia = media && (media.AudioUrl || media.ImageUrl || (!hideScript && media.Script));
              ...
              {!isPart5 && hasMedia && (
                <div className="lg:w-2/5 flex-shrink-0 bg-gradient-to-br from-gray-50 to-gray-100 p-6 border-r border-gray-200">
                  <div className="lg:sticky lg:top-6 space-y-4">
                    ...
                    {/* Script/Passage - CHỈ HIỂN thị cho part 5, 6, 7 */}
                    {!hideScript && media.Script && (
