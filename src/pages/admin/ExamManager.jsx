...
import { Edit, Trash2, Plus, Search, Clock, BookOpen, AlertCircle, Settings, CheckCircle, X, AlertTriangle } from "lucide-react";
import AddExamModal from "./AddExamModal";
import EditExamModal from "./EditExamModal";
import ExamTypeManager from "./ExamTypeManager";

// Modal xác nhận xóa - giống trang bình luận
function DeleteConfirmModal({ isOpen, onClose, onConfirm, examTitle }) {
...
function SuccessModal({ message, onClose }) {
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center z-50 pointer-events-none">
            <div className="bg-green-600 text-white px-6 py-4 rounded-lg shadow-lg flex items-center gap-3 pointer-events-auto">
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-100 p-8">
            ...
            <DeleteConfirmModal
                ...
                examTitle={deleteModal.exam?.Title || ""}
            />
                                    ...
                                    >
                                        ...
                                        <td className="p-4">
                                            ...
                                            <div className="text-xs text-gray-500 mt-1">
                                                Type: {getExamTypeCode(exam.ExamTypeID)}
                                            </div>
                                        </td>
                                        <td className="p-4">
