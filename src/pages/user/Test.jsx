                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            {/* <p className="text-gray-600 mt-2">
                                Khám phá và luyện tập với {exams.length} đề thi chất lượng
                            </p> */}
                        </div>
                        {/* <div className="hidden md:flex items-center gap-2">
                            ...
                            <div className="text-right">
                                ...
                                <p className="text-lg font-bold text-gray-800">{exams.length} đề</p>
                            </div>
                        </div> */}
                    </div>
                </div>
            ...
            <main className="max-w-7xl mx-auto px-6 py-8">
                {/* <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                    ...
                    <div className="bg-white rounded-xl p-5 shadow-md border border-gray-200">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-gray-500 text-sm font-medium">Đề đầy đủ</p>
                                <p className="text-3xl font-bold text-purple-600 mt-1">{stats.fullTest}</p>
                            </div>
                    ...
                    <div className="bg-white rounded-xl p-5 shadow-md border border-gray-200">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-gray-500 text-sm font-medium">Luyện tập</p>
                                <p className="text-3xl font-bold text-green-600 mt-1">{stats.practice}</p>
                            </div>
